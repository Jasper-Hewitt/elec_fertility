...
#create a new  df with only the posts about fertility (284 rows)
...
#___________#__________### PLOT ALL CANDIDATES COMBINED ####___________#__________# 
...
ggplot(l_by_party, aes(x = reorder(Party, Total), y = sum, fill = label)) + #reorder based on total 
